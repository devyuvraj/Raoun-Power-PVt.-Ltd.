...
{
    extract($_POST);
	$qry = "INSERT INTO vendorinfo(Vendorid, Email, Password, Name, Address, Postal, Mobile) VALUES('$id', '$email', '$pwd', '$name', '$address', '$postal', '$mobile')";
    $rs = executequery($qry);
    if($rs == "success")
    {
        $status = "<h2>Record Inserted</h2>";
    }
    else
    {
...
<!--navbar end-->
<!--New vendor Add Section section--->
<div class="container">
	<div class="row mt-4">
		<div class="col-lg-3"></div>
			<div class="col-lg-6 shadow">
				<form class="text-center p-3" method="post" id="frm" name="frm">
					<h1 class="text-center py-2 text-info">Add New Vendor</h1>
